...
def check_pamset(pamset):
    ...
    pamset : dict
          ...
          fpermf is the coefficient of the permafrost feedback
...
class ConcentrationsEmissionsHandler:
    ...
    def emi2conc(self, yr, tdiff=0):
        ...
        yr : int
          Year for which to calculate
        tdiff : float
            temperature change since previous timestep to use for
            permafrost feedback
        """

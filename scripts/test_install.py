...
assert os.path.isfile(os.path.join(ciceroscm_root, "default_data/IPCC_LUCalbedo.txt"))
assert os.path.isfile(os.path.join(ciceroscm_root, "default_data/solar_IPCC.txt"))
assert os.path.isfile(
    os.path.join(ciceroscm_root, "default_data/meanVOLCmnd_ipcc_NH.txt")
)
